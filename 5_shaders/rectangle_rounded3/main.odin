...
main :: proc() {
	...
	dpiScaleLoc := rl.GetShaderLocation(shader, "dpi_scale")
	...
	for !rl.WindowShouldClose() {
		...
		outlineColor: Color = {1, 1, 1, 0.4}

		//dropshadowColor: Color = {0, 0, 0, 0.5}
		dropshadowColor: Color = {0, 0, 0, 0.65}

		dpiScale := [2]f32{1, 1}
		rl.SetShaderValue(shader, dpiScaleLoc, &dpiScale, .VEC2)
